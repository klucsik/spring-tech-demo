...
public class GenerateTodo {
    //source: https://github.com/sameerkumar18/corporate-bs-generator-api/blob/master/buzzwords.js
    private final List<String> adverbs = Arrays.asList("appropriately", "assertively", "authoritatively", "collaboratively", "compellingly", "competently", "completely",
    ...
    private final List<String> verbs = Arrays.asList("actualize", "administrate", "aggregate", "architect", "benchmark", "brand", "build", "communicate", "conceptualize",
    ...
    private final List<String> adjectives = Arrays.asList("24/7", "24/365", "accurate", "adaptive", "alternative", "an expanded array of", "B2B", "B2C", "backend",
    ...
    private final List<String> nouns  = Arrays.asList("action items", "alignments", "applications", "architectures", "bandwidth", "benefits",
